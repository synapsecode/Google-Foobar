...
Considerations:
Must be a consecutive sublist
Needs smallest start and end indexes
start <= end
	...
	for i in range(0, len(l)):
		...
		for j in range(i+1, len(l)):
			...
			if(partialsum == t):
				T.append((i, j))
				break
			# print(((i, inum), (j, jnum), partialsum))
...
solutionx([250,0,0], 250)
solutionx([1,2,3,4], 15)
solutionx([4, 3, 10, 2, 8], 12)
solutionx([4, 3, 5, 7, 8], 12)
solutionx([260], 260)
